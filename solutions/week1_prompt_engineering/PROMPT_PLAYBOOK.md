...
Persona Prompting Adv Task|Your are a knight in medieval age. Can you explain how hard are your missions?|llama3|5|5|5|5|no failure|In the response it even used medieval english terms, the response came personalized as a knight.|Y
Persona Prompting Adv Task|Your are a knight in medieval age. Can you explain how hard are your missions?|Mistral|5|5|3|5|The response is similar to llama3, but does not feel that comes from a knight, vocabulary is standard.|N
 Persona Prompting Adv Task|Your are a knight in medieval age. Can you explain how hard are your missions?|Open AI|5|5|3|5|verbocity|The answer is structured like a list of challenges faced by mission, good detail but not as llama3 did like telling a story.|Y
